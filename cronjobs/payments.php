...
require $_SERVER["DOCUMENT_ROOT"]."/ownsmmpanel/vendor/autoload.php";
...
$url = "https://mails.ownsmmpanel.in/emails?domain=".$_SERVER["HTTP_HOST"]."&access_key=".$access_key."&max_results=".$max_results;
