...
<li class="m-l p-b" class="dropdown">
    ...
    <div style="min-width: 100%;background-color: #fff;box-shadow: 0 0 7px rgba(0, 0, 0, 0.2);border: none;border-radius: 5px;padding: 0;"class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item ab"  data-toggle="modal" data-target="#modalDiv" data-action="assign_category">Assign categories</a>
...
<li class="more-action pull-left"><a style="padding-bottom:29px;padding-top:9px" class="btn btn-primary  m-l custom_method" data-title="Are you want to fatch icons?" data-message="Are you sure? This action can't be reversed?" data-url="admin/services/auto_cat_icon">
                            Auto category icon
                        </a></li>
