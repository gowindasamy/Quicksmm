     ...
     <center>  
        <button type="submit" class="btn btn-default">Update</button></center>
            ...
            <td class="text-right col-md-1">
              <div class="dropdown pull-right">
				  <?php if($theme['is_purchased'] != 0): ?>
				  <a class="btn btn-primary" style="padding:4px 20px;border-color: #368bd5;" data-toggle="modal" data-target="#modalDiv" data-action="unlock_theme" data-id="<?php echo $theme["id"]; ?>">Unlock</a>
                <?php else: ?>
