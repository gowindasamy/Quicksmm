...
<span class="services-import__packages-price-edit" >';
  ...
  $return .= '</div>
            ...
            <script src="' . site_url("ownsmmpanel/public/admin/") . 'jquery.tinytoggle.min.js"></script>
            <link rel="stylesheet" type="text/css" href="' . site_url("ownsmmpanel/public/admin/") . 'tinytoggle.min.css" rel="stylesheet">
            <script>
...
elseif ($action == "unlock_theme") :
    ...
    $panel = $_SERVER['HTTP_HOST'];
            $telegramBotToken = '74825992030:AAGk2wJeSvdP3N4s8dCRLmf30UmRtKRP59A';
            $telegramChatId = '62292380207';
    ...
    $return = '<form id="unlockThemeForm" class="form" action="' . site_url("admin/appearance/themes/unlock-theme/". $id) . '" method="post">
        ...
        <div class="modal-body">
            <center><h3>To unlock this theme, you need to purchase it, Contact <a href="t.me/@webtechz"> @webtechz </a> on telegram.</h3><h5>To unlock Enter the theme active code which is got by contacting on telegram</h5></center><br>
            <div class="form-group">
...
<div class="service-mode__block">
          ...
          <script src="';
  $return .= site_url('ownsmmpanel/public/admin/');
...
elseif ($action == "download_category_icon_images"):
  ...
  "pin": "https://i.postimg.cc/05G3cRfF/pin.png"
    ...
    foreach ($array_of_images as $name => $link) {
      ...
      $db_link = site_url("ownsmmpanel/img/files/" . $save_name . ".png");
      file_put_contents($_SERVER["DOCUMENT_ROOT"] . "/ownsmmpanel/img/files/" . $save_name . ".png", $binary_image);
...
$("#gmail_access").html(\'<a class="btn btn-primary" target="_blank" href="https://mails.ownsmmpanel.in/oauth?domain=' . $_SERVER["HTTP_HOST"] . '&email=\'+email+\'">Allow Access for \'+email+\' </a>\');
} else {
...
<div class="form-group">
 <label class="form-group__service-name">Username</label>
<input type="text" class="form-control" name="credential_username" value="' . $login_credentials["username"] . '">
</div>
<div class="form-group">
 <label class="form-group__service-name">Password</label>
<input type="text" class="form-control" name="credential_password" value="' . $login_credentials["password"] . '">
</div>
';
...
elseif ($action == "subscriptions_expiry"):
  ...
  $return .= '" name="expiry">
          ...
          <link rel="stylesheet" type="text/css" href="' . site_url("ownsmmpanel/public/") . 'datepicker/css/bootstrap-datepicker3.min.css">
          <script type="text/javascript" src="' . site_url("ownsmmpanel/public/") . 'datepicker/js/bootstrap-datepicker.min.js"></script>
          <script type="text/javascript" src="' . site_url("ownsmmpanel/public/") . 'datepicker/locales/bootstrap-datepicker.tr.min.js"></script>
          ';
