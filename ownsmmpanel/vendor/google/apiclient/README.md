...
```php
require_once '/path/to/your-project/ownsmmpanel/vendor/autoload.php';
```
...
remove the `ownsmmpanel/vendorgoogle/apiclient-services` directory explicitly for the
change you made to have effect:

```sh
rm -r ownsmmpanel/vendorgoogle/apiclient-services
composer update
```
...
```php
require_once '/path/to/google-api-php-client/ownsmmpanel/vendor/autoload.php';
```
...
require_once 'ownsmmpanel/vendor/autoload.php';
...
```
ownsmmpanel/vendorbin/phpcs src --standard=style/ruleset.xml -np
```

To automatically fix (fixable) coding style violations, run

```
ownsmmpanel/vendorbin/phpcbf src --standard=style/ruleset.xml
```
