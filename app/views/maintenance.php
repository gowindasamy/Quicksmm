...
<style>
@charset "utf-8";
body{font-family:'Segoe UI',Helvetica Neue,sans-serif;padding:0;margin:0;font-size:16px;color:#095174; background-color:#000000;background-size: 100% auto;background-repeat: no-repeat;}
...
<div id="wrapper" style="text-align:center;">
    <div class="setupbg">
        <div class="padding15">
            ...
            <h4 style="color: #fd4858;"><strong>No need to worry,<br> We are in Maintenance!</strong></h4>
           <div class="line" style="margin:35px 0px;"></div>
            <div style="text-align: center;width: 80%;margin: auto;">

              <strong> We are Making an Edit on our Website, So our Site is in Maintenance Mode. <br><br> You can Visit Again later<br> or Leave This Page Open for Automatic Access When The Site is Active.</strong>
             <br><br><hr><br>
